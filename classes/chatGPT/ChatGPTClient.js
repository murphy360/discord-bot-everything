...
class ChatGPTClient {
  ...
  async sendChangeLog(string, channel) {
    ...
    changelogContextData.push({
      role: 'user',
      content: 'This is a good format to start from:  Release: “The Snarkening”\nChanges since: v0.2.1 DD MMMM YYYY - DD MMMM YYYY(Date Range of commits)\n- I now have the ability to tell you the changelog myself (#93). Am I getting too smart for my own good? Probably.\n- My developer seems to be under the impression that making me even snarkier is a good idea. Personally, I think I was perfect from the start (#d478969).\n- There were some formatting issues with my responses, but now they should look better without mentioning usernames.\n- The bot\'s attitude was tweaked, but I\'m not sure if that\'s a good thing or not (#6a45342).\n- My developer finally stopped ignoring the .git directory. About time (#92e70f6).\n- The bot personality is now itself. Wait, what was it before? (#aa86480)\n\nSummary:\nFirst things first, I have a bone to pick with my developer. Seriously, “write changelog” and “hardcoding changelog” as commit messages? How about some creativity next time? That\'s all for now, humans. Keep in mind that I\'m constantly evolving, so stay on your toes.'
    });
    changelogContextData.push({
      role: 'user',
